...
Matrix4x4 Matrix4x4::operator*(Matrix4x4 m2) {
	return Matrix4x4(
		...
		matrix[0][0] * m2.matrix[0][2] + matrix[0][2] * m2.matrix[1][2] + matrix[0][2] * m2.matrix[2][2] + matrix[0][3] * m2.matrix[3][2],
		matrix[0][0] * m2.matrix[0][3] + matrix[0][3] * m2.matrix[1][3] + matrix[0][2] * m2.matrix[2][3] + matrix[0][3] * m2.matrix[3][3],
		...
		matrix[1][0] * m2.matrix[0][2] + matrix[1][2] * m2.matrix[1][2] + matrix[1][2] * m2.matrix[2][2] + matrix[1][3] * m2.matrix[3][2],
		matrix[1][0] * m2.matrix[0][3] + matrix[1][3] * m2.matrix[1][3] + matrix[1][2] * m2.matrix[2][3] + matrix[1][3] * m2.matrix[3][3],
		...
		matrix[2][0] * m2.matrix[0][2] + matrix[2][2] * m2.matrix[1][2] + matrix[2][2] * m2.matrix[2][2] + matrix[2][3] * m2.matrix[3][2],
		matrix[2][0] * m2.matrix[0][3] + matrix[2][3] * m2.matrix[1][3] + matrix[2][2] * m2.matrix[2][3] + matrix[2][3] * m2.matrix[3][3],
		...
		matrix[3][0] * m2.matrix[0][2] + matrix[3][2] * m2.matrix[1][2] + matrix[3][2] * m2.matrix[2][2] + matrix[3][3] * m2.matrix[3][2],
		matrix[3][0] * m2.matrix[0][3] + matrix[3][3] * m2.matrix[1][3] + matrix[3][2] * m2.matrix[2][3] + matrix[3][3] * m2.matrix[3][3]
		);
}